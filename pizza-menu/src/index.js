...
const pizzaData = [
  ...
  {
    name: "Pizza Proscwcciutto",
    ingredients: "Tomcwcwato, mozarella, ham, aragula, and burrata cheese",
    price: 1098,
    photoName: "pizzas/prosciutto.jpg",
    soldOut: false,
  },
...
function Footer() {
  ...
  // if (!isOpen) return <p> paaaaaaaaaaa!</p>;
  return (
  ...
  //return React.createElement("footer", null, "We're currentry open");
}
